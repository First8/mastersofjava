...
public class FarmFunTester implements Tester.AnimatedTestable {
	...
	private static final int[] BOARDS_X=new int[] {
		2,
		3,
		3,
		4,
        ...
        private static final int[] BOARDS_Y=new int[] {
		1,
		3,
		3,
		4,
	...
	public String getTestDescription(int nr) {
        ...
        ParkingAreaImpl pa=new ParkingAreaImpl(BOARDS_X[nr],BOARDS_Y[nr],PIECES[nr]);
        sb.append(pa);
