...
public class WrongParcelDeliveryTestCase implements ITestCase {
	
	public String getTestCaseName() { return "Wrong parcel delivery"; }
	public String getTestCaseDescription() { return "Testcase where parcel is not delivered to its destination by the mole."; }
	...
	public WrongParcelDeliveryTestCase() {
		createParcels();
		createLocations();
		createShortestPaths();
		createOrders();
	...
	private void createLog() {
		...
		routeLocations2.add(new RouteLocation(locations[4]));
