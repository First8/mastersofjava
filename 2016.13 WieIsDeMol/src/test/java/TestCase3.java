...
public class TestCase3 implements ITestCase {
	
	public String getTestCaseName() { return "Test Case 3"; }
...
//		printShortestPaths();
	...
	private void createOrders() {
		...
		orders.add(new Order(parcels[1], locations[7]));
	}
	...
	private void createLog() {
		...
		routeLocations2.add(new RouteLocation(locations[7], parcels[1]));
