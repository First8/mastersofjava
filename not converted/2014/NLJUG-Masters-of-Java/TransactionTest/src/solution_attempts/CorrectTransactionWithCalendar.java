...
public final class CorrectTransactionWithCalendar implements Comparable<CorrectTransactionWithCalendar> {
	private final BigDecimal amount;
	private final Calendar date;
	private final String description;
	
	public CorrectTransactionWithCalendar(BigDecimal amount, Calendar date, String description) {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof CorrectTransactionWithCalendar)) {
			return false;
		}
		CorrectTransactionWithCalendar other = (CorrectTransactionWithCalendar)obj;
	...
	@Override
	public int compareTo(CorrectTransactionWithCalendar obj) {
