...
public class IpRangeCalculatorSubmitTester implements Tester.Testable {
	private final List<IpRangeTestCase> testCases = new ArrayList<IpRangeTestCase>();

	public IpRangeCalculatorSubmitTester() {
		...
		for (int i = 1; i < 31; i++) {
			this.testCases.add(new IpRangeTestCase("Extra testcase", "80.0.115.6/" + i, "80.0.115.5", "128.0.115.5"));
		}
	}
