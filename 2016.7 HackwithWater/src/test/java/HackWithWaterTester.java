...
public class HackWithWaterTester implements Tester.AnimatedTestable {
	...
	public String getTestDescription(int nr) {
		...
		sb.append(new PipePanelImpl(PANELS[nr].split(";")).toString());
		return sb.toString();
	}
	...
	public boolean performTest(int nr, Anim[] a) throws Throwable {
		...
		//
		PipePanelImpl pp=new PipePanelImpl(PANELS[nr].split(";"),anim,bmp);
		try {
	...
	public static void main(String[] args) throws Throwable{
		System.out.println(new HackWithWaterTester().performTest(4));
	}
